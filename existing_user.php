...
<body background="img2.jpg">
    <marquee bgcolor = "#ccccc" loop = "-1" scrollamount = "10" width = "100%">
        ...
        <center><p><h1 style = "color:purple;">Profile</h1>
        <hr width = "40%" size = "3"/>
        <center>
...
$sql1="SELECT * FROM details_table WHERE Cardno = '$cardno'";
...
if($result ->num_rows>0)
{
    ...
    echo "<br><br><br><b>AREA : </b>&nbsp;&nbsp" . $c. " ";
    echo "<br><br><br><b>BLOOD_GROUP : </b>&nbsp;&nbsp" . $d. " ";
